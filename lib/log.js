...
export const logStateInfo = (context, io, ...args) =>
    log(context.depth,
        [chalk.yellow, chalk.dim, chalk.blue],
        [context.stateKey, context.state.Type, io],
        ...args);

export const logStateSucceed = (context, io, ...args) =>
    log(context.depth,
        [chalk.yellow, chalk.dim, chalk.green],
        [context.stateKey, context.state.Type, io],
        ...args);

export const logStateFail = (context, io, ...args) =>
    log(context.depth,
        [chalk.yellow, chalk.dim, chalk.red],
        [context.stateKey, context.state.Type, io],
        ...args);

export const logMachineInfo = (context, key, io, ...args) =>
    log(context.depth,
        [chalk.dim, chalk.dim, chalk.blue],
        [key, 'Machine', io],
        ...args);

export const logMachineSucceed = (context, key, io, ...args) =>
    log(context.depth,
        [chalk.dim, chalk.dim, chalk.green],
        [key, 'Machine', io],
        ...args);

export const logMachineFail = (context, key, io, ...args) =>
    log(context.depth,
